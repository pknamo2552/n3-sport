  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      <ul class="navbar-nav ms-auto align-items-lg-center">
        <li class="nav-item"><a class="nav-link<?= is_active('equipment.php') ?>" href="<?= $GLOBALS['base'] ?>equipment.php">Equipment</a></li>
        ...
        <?php else: ?>
          ...
          <li class="nav-item"><a class="nav-link" href="<?= $GLOBALS['base'] ?>logout.php">Logout</a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>
